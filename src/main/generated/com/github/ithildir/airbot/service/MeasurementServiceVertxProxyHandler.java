...
public class MeasurementServiceVertxProxyHandler extends ProxyHandler {
  ...
  public MeasurementServiceVertxProxyHandler(Vertx vertx, MeasurementService service) {
    this(vertx, service, DEFAULT_CONNECTION_TIMEOUT);
  }

  public MeasurementServiceVertxProxyHandler(Vertx vertx, MeasurementService service, long timeoutInSecond) {
    this(vertx, service, true, timeoutInSecond);
  }

  public MeasurementServiceVertxProxyHandler(Vertx vertx, MeasurementService service, boolean topLevel, long timeoutSeconds) {
    this.vertx = vertx;
