...
public class MeasurementServiceVertxEBProxy implements MeasurementService {
  ...
  public MeasurementServiceVertxEBProxy(Vertx vertx, String address) {
    this(vertx, address, null);
  }

  public MeasurementServiceVertxEBProxy(Vertx vertx, String address, DeliveryOptions options) {
    this._vertx = vertx;
